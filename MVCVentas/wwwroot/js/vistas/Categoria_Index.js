...
$("#btnGuardar").click(function () {
    ...
    console.log(modelo.categoriaId)
    ...
    swal({
        ...
        function (respuesta) {
            ...
            if (respuesta) {
                ...
                fetch(`/Categoria/Eliminar?idCategoria=${data.categoriaId}`, {
                    method: "DELETE"
                })
                  ...
                  .then(response => {
                    ...
                    if (responseJson.estado) {
                        ...
                        swal("¡Listo!", "La categoria fue eleminada", "success")
                    } else {
                        swal("¡Error!", responseJson.mensaje, "error")
                    }
